...
namespace CTFCosts
{
	...
	s32 buildershop_wood, quarters_wood, knightshop_wood, archershop_wood,
		...
		quarry_stone, quarry_gold, quarry_count, warboat_gold;
...
void InitCosts()
{
	...
	CTFCosts::warboat_gold =				ReadCost(cfg, "cost_vehicleshop_gold"       , 50);

	//ArcherShop.as
	CTFCosts::arrows =                      ReadCost(cfg, "cost_arrows"             , 15);
	CTFCosts::waterarrows =                 ReadCost(cfg, "cost_waterarrows"        , 25);
	CTFCosts::firearrows =                  ReadCost(cfg, "cost_firearrows"         , 35);
	CTFCosts::bombarrows =                  ReadCost(cfg, "cost_bombarrows"         , 50);

	//KnightShop.as
	CTFCosts::bomb =                        ReadCost(cfg, "cost_bomb"               , 30);
	CTFCosts::waterbomb =                   ReadCost(cfg, "cost_waterbomb"          , 40);
	...
	CTFCosts::ballista =                    ReadCost(cfg, "cost_ballista"           , 150);
	...
	WARCosts::drill_stone =             ReadCost(cfg, "cost_drill_stone"        , 50);
