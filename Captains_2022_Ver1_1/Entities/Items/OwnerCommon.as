CPlayer@ getHolderPlayer(CBlob@ this)
{
	if (this.exists("holder"))
	{
		u16 ownerID = this.get_u16("holder");
...
{
	if (isServer() && owner_player !is null)
	{
		this.set_u16("holder", owner_player.getNetworkID());
		this.Sync("holder", true);
	}
