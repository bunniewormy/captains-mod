...
{
	if (this.getName() == "teleportbomb" &&	this.exists("owner blob"))
	{
		CBitStream bt;
		bt.write_u16(this.get_u16("owner blob"));
		bt.write_u16(this.getNetworkID());

		this.SendCommand(this.getCommandID("teleport bomb"), bt);
	}
	else
	{
