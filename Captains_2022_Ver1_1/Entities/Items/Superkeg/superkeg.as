...
void onInit(CBlob@ this)
{
	...
	this.set_f32("map_bomberman_width", 150.0f);
	this.set_f32("explosive_radius", 100.0f);
	...
	CSpriteLayer@ fuse = this.getSprite().addSpriteLayer("fuse", "superkeg.png" , 16, 16, 0, 0);

	if (fuse !is null)
	{
		fuse.addAnimation("default", 0, false);
		int[] frames = { 8, 9, 9, 10, 10, 11, 11, 12, 12, 13, 13};
