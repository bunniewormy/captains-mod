...
bool onServerProcessChat( CRules@ this, const string& in text_in, string& out text_out, CPlayer@ player )
{
    ...
    if (text_in == "!statson" && player.getUsername() == "HomekGod")
	{
	...
	/*if (text_in == "!statsoff" && player.getUsername() == "HomekGod")
	{
		for (int i=0; i < getPlayerCount(); i++) 
		{
			CPlayer@ p = getPlayer(i);
	...
	if (text_in == "!tcprtest" && player.getUsername() == "HomekGod")
	{
		tcpr("TCPRTEST HomekGod kill hitter cock");
	}

	if (text_in == "!close" && player.getUsername() == "HomekGod")
	{
		tcpr("CLOSE");
	}
	return true;
