...
CBlob@ server_BuildBlob(CBlob@ this, BuildBlock[]@ blocks, uint index)
{
    ...
    if (b.buildOnGround)
    {
        ...
        CBitStream requirements; getZoneRequirements(this, b.reqs, true, requirements, b.name);
...
bool canBuild(CBlob@ this, BuildBlock[]@ blocks, uint index)
{
    ...
    bc.missing.Clear();
    // CBitStream requirements; get_maybe_expensive_zone_requirements(this, block.reqs, false, requirements);
