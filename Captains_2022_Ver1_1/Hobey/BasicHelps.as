...
void onInit(CRules@ this)
{
    ...
    AddIconToken("$HealBomb$", "Entities/Characters/Knight/KnightIcons.png", Vec2f(16, 32), 5);
    ...
    AddIconToken("$HealArrow$", "Entities/Characters/Archer/ArcherIcons.png", Vec2f(16, 32), 4);
    ...
    AddIconToken("$workshop$", "Entities/Common/GUI/HelpIcons.png", Vec2f(16, 16), 2);
        AddIconToken("$teleportbombicon$", "TeleportBombIcon.png",Vec2f(16, 32), 0);
