...
float drawScoreboard(CPlayer@ localplayer, CPlayer@[] players, Vec2f topleft, CTeam@ team, Vec2f emblem)
{
	...
	GUI::DrawText(getTranslatedString("Username"), Vec2f(bottomright.x - 510, topleft.y), SColor(0xffffffff));
	GUI::DrawText(getTranslatedString("Ping"), Vec2f(bottomright.x - 370, topleft.y), SColor(0xffffffff));
	GUI::DrawText(getTranslatedString("Kills"), Vec2f(bottomright.x - 290, topleft.y), SColor(0xffffffff));
	GUI::DrawText(getTranslatedString("Deaths"), Vec2f(bottomright.x - 210, topleft.y), SColor(0xffffffff));
	GUI::DrawText(getTranslatedString("MatDrops"), Vec2f(bottomright.x - 130, topleft.y), SColor(0xffffffff));
	...
	for (u32 i = 0; i < players.length; i++)
	{
		...
		GUI::DrawText("" + username, Vec2f(bottomright.x - 510, topleft.y), namecolour);
		GUI::DrawText("" + ping_in_ms, Vec2f(bottomright.x - 370, topleft.y), SColor(0xffffffff));
		GUI::DrawText("" + p.getKills(), Vec2f(bottomright.x - 290, topleft.y), SColor(0xffffffff));
		GUI::DrawText("" + p.getDeaths(), Vec2f(bottomright.x - 210, topleft.y), SColor(0xffffffff));
		GUI::DrawText("" + p.getAssists(), Vec2f(bottomright.x - 130, topleft.y), SColor(0xffffffff));
...
{
	if(this.get_u32("tabmode") == 2 || this.get_u32("tabmode") == 3)
	{
		return;
	}
	//sort players
